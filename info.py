...
# Bot information
SESSION = environ.get('SESSION', 'EagleBot')
API_ID = int(environ.get('API_ID', '13379820'))
API_HASH = environ.get('API_HASH', '77fdc5ce1fdcdccf2823978dfb533894')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1002758303').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002081989726'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002210271866').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rxrx1850:2MbPCsM06EHTiyew@cluster0.kuhr4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+oPW30s_Nuj0xMTg1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+oPW30s_Nuj0xMTg1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Eagle_Movies1') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https:/t.me/Eageless')
